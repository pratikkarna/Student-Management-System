...
void login()
{
    ...
    char user[]="pratikkarna";
    char pass[10]="pratik.7";
    do
{
	system("cls");
	setcolor(8);
	...
	i=0;
	//scanf("%s",&pword); 
		if(strcmp(uname,"pratikkarna")==0 && strcmp(pword,"pratik.7")==0)
	{
...
printf("\t\t\t\t\t\t\t\t PROGRAM ON STUDENTS RECORD MANAGEMENT SYSYEM\n\n");  
	...
	printf("\t\t\t\t\t\t\t||                                              ||\n");
	printf("\t\t\t\t\t\t\t||        ---------------------------------     ||\n");
	printf("\t\t\t\t\t\t\t||                   Stark College              ||\n");
	printf("\t\t\t\t\t\t\t||        ---------------------------------     ||\n");
	printf("\t\t\t\t\t\t\t||                                              ||\n");
	printf("\t\t\t\t\t\t\t||          SUBJECT TEACHER : Prof Stark        ||\n");
	printf("\t\t\t\t\t\t\t||                                              ||\n");
	printf("\t\t\t\t\t\t\t||          Brought To You Pratik Karna         ||\n");
	printf("\t\t\t\t\t\t\t||                                              ||\n");
	printf("\t\t\t\t\t\t\t||______________________________________________||\n\n\n");
